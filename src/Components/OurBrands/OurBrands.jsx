...
const OurBrands = () => {
    ...
    return (
        <div className="mt-20">
            ...
            <Marquee pauseOnHover={true} className="my-20">
                    {
                        brands.map(brand=><div className="px-5" key={brand._id}>
                               <img className="md:w-[500px] w-[300px] md:h-[400px] h-[200px] object-cover" src={brand.Image} alt="" />
                                 ...
                                 <Link><button className="bg-slate-400 text-white rounded-lg p-2 mt-3">Explore all {brand.Brand_Name} cars</button></Link>
                                 </div>
